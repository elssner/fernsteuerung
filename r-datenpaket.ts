...
namespace receiver { // r-datenpaket.ts
    ...
    export function sendM0(receivedData: Buffer) {
        ...
        if (radio.isBetriebsart(receivedData, radio.e0Betriebsart.p0)) {
            receiver.dualMotor128(receiver.eMotor01.M0, radio.getByte(receivedData, radio.eBufferPointer.m0, radio.eBufferOffset.b0_Motor))
            receiver.servo_set16(radio.getByte(receivedData, radio.eBufferPointer.m0, radio.eBufferOffset.b1_Servo))
            receiver.dualMotor128(receiver.eMotor01.M1, radio.getByte(receivedData, radio.eBufferPointer.m1, radio.eBufferOffset.b0_Motor))
